...
fn tsume1_drop_white_knight_on_first_rank_is_illegal() {
  batch_test(vec![
    "l1+L6/9/p1pL3Gp/2s+Bp1pp1/2Np3P1/P1P6/1PKP1SB1P/2Gg+nr3/L4k3 b RG2SN5Pn 179",
  ]);
}

#[test]
fn tsume1_futile_drops() {
  batch_test(vec!["6Snl/5+Rg1k/6ppp/9/9/9/9/9/9 b r2b3g3s3n3l15p 5"]);
}
